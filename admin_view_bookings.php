...
$stmt = $pdo->prepare("SELECT b.*, f.name as facility_name, u.username, u.email FROM bookings b JOIN facilities f ON b.facility_id = f.id JOIN users u ON b.user_id = u.id ORDER BY b.booking_time DESC");
$stmt->execute();
...
<head>
    ...
    <title>View All Bookings - UniPlay Admin</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="admin_view_bookings.php">View Bookings</a>
                    </li>
                    <li class="nav-item">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($booking['username']); ?> (<?php echo htmlspecialchars($booking['email']); ?>)</td>
